...
<body>
    ...
    <div class="container">
        ...
        <div class="alert alert-warning alert-dismissible fade show" role="alert">
            <strong>Última actualización: 17/02/2019</strong>
        ...
        <?php 
            if(isset($_GET["ctl"])){
                ...
                require_once("app/controlador/comentarios.php");
            }else{
        ?>
            ...
            <ul class="list-unstyled my-4">
                ...
                <li class="media my-4 border border-5 my-4">
                    ...
                    <div class="media-body">
                        ...
                        Java es un lenguaje de programación de propósito general, concurrente, orientado a objetos, que fue diseñado específicamente para tener tan pocas dependencias de implementación como fuera posible. Su intención es... <a href="index.php?ctl=java">Leer más</a>
                    </div>
                </li>
                <li class="media my-4 border border-5 my-4">
                    ...
                    <div class="media-body">
                        ...
                        Al igual que B, es un lenguaje orientado a la implementación de Sistemas operativos, concretamente Unix. C es apreciado por la eficiencia del código que produce y es el lenguaje de programación más popular para... <a href="index.php?ctl=c">Leer más</a>
                    </div>
                </li>
                <li class="media my-4 border border-5 my-4">
                    ...
                    <div class="media-body">
                        <h5 class="mt-0 mb-1">C++</h5>
                        C++ es un lenguaje de programación diseñado en 1979 por Bjarne Stroustrup. La intención de su creación fue extender al lenguaje de programación C mecanismos que permiten la manipulación de objetos. En ese sentido...<a href="index.php?ctl=c##">Leer más</a>
                    </div>
                </li>
            </ul>
        <?php
